            ...
            if value and isinstance(value[0], str):
                ...
                if reviver := revivers.get(value[0]):
                    ...
                    try:
                        ...
                        # parse_iso8601 raises ValueError/TypeError for invalid strings;
                        # datetime.fromtimestamp raises OSError/ValueError/OverflowError
                        # for out-of-range timestamps (e.g. year < 1 or > 9999).
